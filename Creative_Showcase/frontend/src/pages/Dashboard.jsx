...
export default function Dashboard() {
  ...
  return (
    <Page>
      <h1 className="text-4xl font-bold mb-8 bg-linear-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
        Your Creations
      </h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-purple-50 rounded-2xl border-2 border-dashed border-purple-200">
