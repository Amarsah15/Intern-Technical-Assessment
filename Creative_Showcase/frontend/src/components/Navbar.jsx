      ...
      <nav className="bg-white shadow-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            >
              <img src="/logo.svg" alt="Logo" className="h-10 inline mr-2" />
              Creative Showcase
            </Link>
            ...
            <div className="hidden md:flex gap-6 items-center">
              {!isAuthenticated ? (
                <>
                  ...
                  <Link
                    to="/signup"
                    className="px-5 py-2 bg-linear-to-r from-purple-600 to-blue-600 text-white rounded-lg font-medium hover:shadow-lg transition-all"
                  >
                    Join Free
                  </Link>
                </>
              ...
              {!isAuthenticated ? (
                <>
                  ...
                  <Link
                    to="/signup"
                    onClick={() => setMobileMenuOpen(false)}
                    className="block w-full text-center px-5 py-2 bg-linear-to-r from-purple-600 to-blue-600 text-white rounded-lg font-medium"
                  >
                    Join Free
                  </Link>
                </>
